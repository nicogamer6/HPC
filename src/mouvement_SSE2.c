...
////////////////////////////////////////
//       SIGMA DELTA STEP1 SSE ROW        //
////////////////////////////////////////


void SigmaDelta_1step_SSE2_row (vuint8* V,vuint8* Vtm1, vuint8* M, vuint8* Mtm1, vuint8* It, vuint8* Et,long nrl, long nrh, long ncl, long nch)
{
  //  vuint8 Mtmoins1, Mt, It, Vtmoins1, Vt, Et, res;
    vuint8 v_M, v_It, v_Mtm1, v_V, v_Vtm1, sel;
    vuint8 Ot;
    ...
    //for (int i = nrl ; i <= nrh ; i++){
        for (int j = ncl ; j <= nch ; j++){
            ...
            v_Vtm1 = _mm_load_si128((vuint8*) &Vtm1[j]);
            v_It = _mm_load_si128((vuint8*) &It[j]);
            v_Mtm1 = _mm_load_si128((vuint8*) &Mtm1[j]);
